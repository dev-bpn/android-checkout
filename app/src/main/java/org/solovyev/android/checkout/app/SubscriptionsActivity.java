...
public class SubscriptionsActivity extends AppCompatActivity {
    ...
    private void reloadInventory() {
        ...
        request.loadSkus(SUBSCRIPTION, Subscription.skus());
        ...
        mChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position >= 0 && position < mTargetSkusAdapter.getCount()) {
                    change(checked, mTargetSkusAdapter.getItem(position).mSku);
                }
            }
        });
        ...
        mBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position >= 0 && position < adapter.getCount()) {
                    purchase(adapter.getItem(position).mSku);
                }
            }
        });
    ...
    private static class PurchasedSkusAdapter extends RecyclerView.Adapter<ViewHolder> implements Inventory.Callback {
        ...
        public void onChecked(Sku sku, boolean checked) {
            ...
            if (before != after) {
                mListener.onCheckedChanged(after);
            }
        }
        ...
        public void onLoaded(@Nonnull Inventory.Products products) {
            ...
            notifyDataSetChanged();
            if (checkedChanged) {
                mListener.onCheckedChanged(mChecked.size());
            }
        }
